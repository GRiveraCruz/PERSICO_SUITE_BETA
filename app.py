...
# (full) puede ver/editar. Un usuario con "Crear" solo puede tocar fechas y
# Target de Ahorro; estos campos se preservan del valor ya guardado si el
# usuario no tiene permiso full, sin importar lo que envíe el cliente.
PROJCONFIG_FULL_ONLY_JOB_FIELDS = {
    "markup_pct", "monto_markup", "presupuesto_operativo",
    "est_ing_mecanica", "est_ing_electrica", "est_major_items",
    "est_material_mecanico", "est_material_electrico", "est_servicios_externos", "est_ensamble",
    "suma_estimados", "delta_vs_disponible",
    "margen_pct", "presupuesto_a", "target_compras", "target_mo",
}
