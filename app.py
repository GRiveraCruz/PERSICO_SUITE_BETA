...
def api_control_horas_exportar_mano_obra():
    ...
    with lock:
        ...
        for row in rows:
            ...
            costo_hora = _costo_por_hora_sueldo(salario, anios, uma, isn_pct, prima_vac_pct) if salario else 0
            if not salario:
    ...
    return jsonify({"ok": True, "added": added, "sin_salario": sorted(sin_salario)})
