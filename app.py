...
def api_asistencia_link_worker():
    ...
    # Evita vincular el mismo trabajador de la Suite a dos entradas del kiosco
...
# (equivalente al "Control de Horas" del kiosco, pero las firmas de autorización
#  usan la sesión ya autenticada de la Suite en vez de pedir contraseña de nuevo)
...
def _ctrl_horas_rows(from_date, to_date, worker_tid=None, job_filter=None):
    """Trae records+workers del kiosco, arma las filas de distribución por job ya
    enriquecidas con nombre/puesto/área de la Suite (misma lógica que /api/asistencia/records)."""
