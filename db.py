...
class Proveedor(Base, JSONBMixin, ContentHashMixin):
...
class WorkHour(Base, JSONBMixin):
    ...
    source_id = Column(Integer, unique=True, index=True)  # "id" tal cual venía en el JSON de origen
    year = Column(Integer, nullable=False, index=True)
    employee = Column(String, index=True)
    job = Column(String, index=True)
...
#  FINANZAS
# ══════════════════════════════════════════════════════════════════
class EsquemaTributario(Base, JSONBMixin, ContentHashMixin):
    __tablename__ = "esquemas_tributarios"


class Recepcion(Base, JSONBMixin, ContentHashMixin):
    __tablename__ = "recepciones"
    job = Column(String, index=True)


class ProcesarCompra(Base, JSONBMixin, ContentHashMixin):
...
#  LOGÍSTICA / OTROS
# ══════════════════════════════════════════════════════════════════
class Ingreso(Base, JSONBMixin, ContentHashMixin):
...
class Salida(Base, JSONBMixin, ContentHashMixin):
    __tablename__ = "salidas"
    job = Column(String, index=True)


class Viatico(Base, JSONBMixin, ContentHashMixin):
    __tablename__ = "viaticos"
    job = Column(String, index=True)


class GastoViaje(Base, JSONBMixin, ContentHashMixin):
    __tablename__ = "gastos_viaje"
    job = Column(String, index=True)


class Envio(Base, JSONBMixin, ContentHashMixin):
