...
function gpoEsquemaChange() {
  ...
  // Sincroniza el % de IVA general de la PO con el del esquema elegido
  const ivaField = document.getElementById('gpo-iva');
  if(ivaField) ivaField.value = esquema.iva_trasladado || 0;
