...
function pcRenderPersonalTable() {
  ...
  thead.innerHTML = `
    ...
    <th style="position:sticky;left:170px;${sb};z-index:2;width:80px;text-align:right">Rate</th>
    <th style="position:sticky;left:250px;${sb};z-index:2;width:90px;text-align:right">Total Hours</th>
    <th style="position:sticky;left:340px;${sb};z-index:2;width:100px;text-align:right;border-right:2px solid var(--border)">Total Amount</th>
...
function pcAddPersonaRow(data={}) {
  ...
  tr.innerHTML = `
    ...
    <td style="position:sticky;left:170px;${sb};z-index:1;text-align:right;font-family:'DM Mono',monospace" id="${rowId}-rate">—</td>
    <td style="position:sticky;left:250px;${sb};z-index:1;text-align:right;font-family:'DM Mono',monospace;font-weight:700" id="${rowId}-hours">0</td>
    <td style="position:sticky;left:340px;${sb};z-index:1;text-align:right;font-family:'DM Mono',monospace;font-weight:700;color:var(--gold);border-right:2px solid var(--border)" id="${rowId}-amount">$0.00</td>
...
function pcUpdatePersonalTotals() {
  ...
  [...tb.rows].forEach(tr => {
    ...
    const hours = [...tr.querySelectorAll('[data-day]')].reduce((s,inp)=>s+(parseFloat(inp.value)||0),0);
    totHours += hours; totAmount += rate*hours;
  });
...
function pcApplyImportedPersonal(records) {
  ...
  records.forEach(rec => {
    ...
    if(!existingTr) {
      pcAddPersonaRow({employee: rec.employee, days: daysInRange});
      personasNuevas++;
    } else {
