...
function pcRenderPersonalTable() {
  ...
  thead.innerHTML = `
    <th style="position:sticky;left:0;${sb};z-index:2;width:220px">Person</th>
    <th style="position:sticky;left:220px;${sb};z-index:2;width:190px">Área</th>
    <th style="position:sticky;left:410px;${sb};z-index:2;width:80px;text-align:right">Rate</th>
    <th style="position:sticky;left:490px;${sb};z-index:2;width:90px;text-align:right">Total Hours</th>
    <th style="position:sticky;left:580px;${sb};z-index:2;width:100px;text-align:right;border-right:2px solid var(--border)">Total Amount</th>
...
function pcAddPersonaRow(data={}) {
  ...
  tr.innerHTML = `
    ...
    <td style="position:sticky;left:220px;${sb};z-index:1">
    ...
    <td style="position:sticky;left:410px;${sb};z-index:1;text-align:right;font-family:'DM Mono',monospace" id="${rowId}-rate">—</td>
    <td style="position:sticky;left:490px;${sb};z-index:1;text-align:right;font-family:'DM Mono',monospace;font-weight:700" id="${rowId}-hours">0</td>
    <td style="position:sticky;left:580px;${sb};z-index:1;text-align:right;font-family:'DM Mono',monospace;font-weight:700;color:var(--gold);border-right:2px solid var(--border)" id="${rowId}-amount">$0.00</td>
